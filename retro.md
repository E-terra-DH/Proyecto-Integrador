...
- Resolver los pendientes que fueron quedando de sprints anteriores.
- Mirar de nuevo clases que impacten el sprint
- Distribución de tareas al inicio del sprint.
- Editar BIO cada uno
- Formulario de edit, metodos soft delete
- Funcionalidades de los botones
- Dejar un carrito de compras funcional

# 2. Hacer mas.

- Juntarnos a programar juntos.
- Practicar temas que estan con menos profundidad. \* hacer ramas
- Ver como mejoramos orden y temas de la pagina (front y back)

# 3. Continuar haciendo.

- Seguir juntandonos, por meet y mantener la comunicacion en el grupo.
- Organizar y definer con claridad las tareas de cada uno.
- Ayudarnos entre todos.
- Mirar alternativas de aprendizaje.
-
...
Dejar mucha responsabilidad sobre uno solo de los compañeros. Nos pasó que Maira fue la que más trabajó en este y todos los sprint porque es quien más sabe de diseño, entonces recayó una responsabilidad muy grande sobre ella.

Que Maira nos organice el orden del codigo
